...
import gunveer.codes.learningkotlin.utils.*
...
class CreateActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode != PICK_PHOTO_CODE || resultCode != RESULT_OK || data == null){
            Log.w(TAG, "Did not get the data back from the launched activity, user likely cancelled the selection flow.")
            return
        }
    ...
    private fun saveDataToFirebase() {
        ...
        //checking whether the game already exists
